  ...
  useEffect(() => { 
    ...
    return (
      <div className="flex justify-center">
        {advertisementProductShow == 0 ? 'loading...'  : 
         ( <Row className="flex justify-around py-24 px-12 container AdvertisementProducts" gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            <Col span={6} className="flex justify-center gutter-row AdvertisementProductsIpad">
              <SmallAdver image={advertisementProductShow[0].imageAdvertisementProducts} productName={advertisementProductShow[0].titleAdvertisementProducts} description={advertisementProductShow[0].describeAdvertisementProducts} />
            </Col>
            <Col span={12} className="flex justify-center gutter-row AdvertisementProductsIpad">
              <BigAdver 
                productName={advertisementProductShow[1].titleAdvertisementProducts} 
                description={advertisementProductShow[1].describeAdvertisementProducts} 
            ...
            <Col span={6} className="flex justify-center gutter-row AdvertisementProductsIpad">
              <SmallAdver image={advertisementProductShow[2].imageAdvertisementProducts} productName={advertisementProductShow[2].titleAdvertisementProducts} description={advertisementProductShow[2].describeAdvertisementProducts} />
            </Col>
          </Row>) 
        }
      </div>
