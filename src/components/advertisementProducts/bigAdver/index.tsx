...
function BigAdver(props: PropsBigAdver) {
  return (
    ...
    >
      <Row
        className="flex justify-center z-10 w-full container"
      ...
      >
        ...
        <Col
          span={16}
          className="flex justify-center gutter-row bigAdverMobile"
        >
          <div className="items-start p-8 inforAdvertisementProducts">
            ...
            <div className="flex flex-col justify-start">
              <p className="text-ellipsis overflow-hidden ... pt-4 text-sm text-left text-stone-400 w-46 h-24">
                {props.description}
              </p>
            </div>
            <div className="flex flex-row justify-start items-start pt-6">
              <div className="flex flex-row justify-start text-slate-500 items-start font-medium">
                Sales Start from
              </div>
              <div className="text-amber-500 pl-2 font-medium">
                $ {props.price}
              </div>
            </div>
            <Space className="items-start mt-6">
              <Button
                type="primary"
                className="flex justify-center capitalize p-5 text-base font-medium border-slate-500 hover:text-slate-50 discoverMore"
              >
